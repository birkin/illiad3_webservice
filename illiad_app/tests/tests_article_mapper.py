...
class Article_Mapper_Test( TestCase ):
 ...
 'response': {'bib': {'_rfr': 'google',
        ...
        self.assertEqual( self.mapper.grab_volume(bib_dct), 'z102' )
        self.assertEqual( self.mapper.grab_issue(bib_dct), 'z4' )
        ...
        self.assertEqual( self.mapper.grab_sid(bib_dct), 'zgoogle' )
