...
class Book_Mapper_Test( TestCase ):
 ...
 'response': {'bib': {'_rfr': 'info:sid/firstsearch.oclc.org:WorldCat',
    ...
    def test_bib_dct_L(self):
        """ Checks mapping of WorldCat oclc# `823176599`
            Initially failed because publisher was too long. """
        bib_dct = {
 ...
 'response': {'bib': {'_rfr': 'info:sid/firstsearch.oclc.org:WorldCat',
        ...
        self.assertEqual( self.mapper.grab_title(bib_dct), 'Desire love' )
        self.assertEqual( self.mapper.grab_author(bib_dct), 'Berlant, Lauren' )
        self.assertEqual( self.mapper.grab_sid(bib_dct), 'info:sid/firstsearch.oclc.org:WorldCat' )
        self.assertEqual( self.mapper.grab_espn(bib_dct), '823176599' )
        self.assertEqual( self.mapper.grab_isbn(bib_dct), '9780615686875' )
        self.assertEqual( self.mapper.grab_date(bib_dct), '2012' )
